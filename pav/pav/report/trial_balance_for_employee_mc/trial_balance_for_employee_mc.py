...
def get_data(filters, show_party_name):
	...
	elif filters.get('party_type') == 'Employee Account':
		party_name_field = 'employee'
	elif filters.get('party_type') == 'Employee':
		party_name_field = 'employee'
		filters['party_type']='Employee Account'
	...
	for party in parties:
		row = { "party": party.get(party_name_field) }
		if show_party_name:
			row["party_name"] = frappe.db.get_value("Employee",{"name": party.get(party_name_field)}, "employee_name")
